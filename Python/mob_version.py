...
# carries a stamp and merely listed if it does not. A recipe's own master lives wherever the recipe
# points, so it is checked by path from mob_verify rather than listed here.
REQUIRED = (
    '/MobMaterials/Landscape/M_MobLandscape',
    '/MobMaterials/Trample/M_MobTrampleFade',
    '/MobMaterials/Trample/M_MobTrampleStamp',
    '/MobMaterials/MPC_MobTrample',
    '/MobMaterials/MPC_MobRustle',
)
